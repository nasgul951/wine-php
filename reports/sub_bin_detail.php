<?php	include("../security/login_check.php");
		include("process/p_inc_bin_detail.php");
?>
...
<form name="frmMain" action="sub_bin_detail.php" method="post">
	<input type="hidden" name="bin_x" value="">
	<input type="hidden" name="bin_y" value="">
</form>
</body>
</html>
