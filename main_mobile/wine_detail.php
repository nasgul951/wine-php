...
<div id="body_main">
	...
	<tr><td nowrap><b>Vineyard:</b></td>
		...
		<td nowrap colspan="2"><input id="txt_vineyard" type="text" name="label" value="<?php echo $rowWine["label"]; ?>" maxlength="50" size="30"></td></tr>
	<tr><td nowrap><b>Varietal:</b></td>
		<td nowrap><input id="txt_vineyard" type="text" name="varietal" value="<?php echo $rowWine["varietal"]; ?>" maxlength="30"></td>
		<td nowrap align="right"><b>Vintage:</b></td>
		<td nowrap><input id="txt_vineyard" type="text" name="vintage" value="<?php echo $rowWine["vintage"]; ?>" size="4"></td>
		<td nowrap align="right"><input type="submit" value="Update" name="upd_wine"></td></tr>
	</table>
	</form>
	...
	<div id="body_detail">
		...
		<div id="detail_scroll">
			...
			<?php } // end while ?>
			<form action="wine_detail.cfm" method="post">
				<input type="hidden" name="wine_id" value="<?php echo $wineid; ?>">
				<tr>
					<td nowrap>
