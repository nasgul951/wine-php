<?php include("../include/data.php");
	...
	if ( isset($_POST["add"]) ) {
		$sql = "
		INSERT INTO tblWineList (vineyard, label, varietal, vintage, created_date, notes)
		VALUES ('".$_POST["vineyard"]."', '".$_POST["label"]."', '".$_POST["varietal"]."', ".$_POST["vintage"].", CURRENT_TIMESTAMP, '".$_POST["notes"]."')";
		run_update($sql);
	...
	if ( $wineid == "NULL" ) {
		...
		$sql = "
			SELECT wineid, vineyard, label, varietal, vintage, ts_date, notes
			FROM tblWineList
			WHERE wineid = ".$wineid;
